...
namespace HelenaGerber_Promo.Controllers.Admin
{
    ...
    public class ModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Goal,Description")] Model model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Goal,Description")] Model model)
        {
            if (ModelState.IsValid)
            {
